...
function add_option(forWhat) {
	var holder       = document.getElementById(forWhat + '_more'),
		...
		newOptionV   = document.createElement( 'input' ),
	...
	newOptionV.setAttribute( 'type', 'text' );
	newOptionV.setAttribute( 'name', forWhat + '_value[' + theId + ']' );
	newOptionV.setAttribute( 'id', forWhat + '_value' + theId );
	newOptionV.setAttribute( 'placeholder', 'language code: es,en,ro' );
