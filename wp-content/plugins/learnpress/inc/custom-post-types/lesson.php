		...
		function register_post_type() {
			...
			register_post_type( LPR_LESSON_CPT,
				array(
					...
					'show_ui'            => true,
					'has_archive'        => ( $page_id = learn_press_get_page_id( 'lessons' ) ) && get_post( $page_id ) ? get_page_uri( $page_id ) : _x( 'lessons', 'Permalink Slug', 'learn_press' ),
			...
			register_taxonomy( 'lesson-tag', array( LPR_LESSON_CPT ),
				array(
					...
					'show_in_nav_menus' => true,
					'rewrite'           => array( 'slug' => _x( 'lesson-tag', 'Permalink Slug', 'learn_press' ), 'hierarchical' => true, 'with_front' => true ),
				)
			);
