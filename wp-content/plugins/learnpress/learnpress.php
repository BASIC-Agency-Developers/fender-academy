...
if ( !class_exists( 'LearnPress' ) ) {
	...
	class LearnPress {
		...
		function define_const() {
            ...
            $this->define( 'LPR_TRIVIA_CPT', 'lpr_course' );
			...
			$this->define( 'LPR_QUIZ_CPT', 'lpr_quiz' );
                        $this->define( 'LPR_TRIVIAQ_CPT', 'lpr_quiz' );
		...
		function include_post_types() {
            ...
            require_once 'inc/custom-post-types/trivia.php';
			require_once 'inc/custom-post-types/triviaQuiz.php';
		}
		...
		public function admin_menu() {
			...
			$menu_items = array(
				...
				'iqpoints'     => array(
					'learn_press',
					__( 'IQ Points', 'learn_press' ),
					__( 'IQ Points', 'learn_press' ),
					'manage_options',
					'learn_press_iqpoints',
					'learn_press_iqpoints_page'
				)
			);
		...
		public function add_user_roles() {
			...
			$admin->add_cap( 'delete_lpr_trivia' );
			$admin->add_cap( 'delete_published_lpr_trivia' );
			$admin->add_cap( 'edit_lpr_trivia' );
			$admin->add_cap( 'edit_published_lpr_trivia' );
			$admin->add_cap( 'publish_lpr_courses' );
			$admin->add_cap( 'delete_private_lpr_trivia' );
			$admin->add_cap( 'edit_private_lpr_trivia' );
			$admin->add_cap( 'delete_others_lpr_trivia' );
			$admin->add_cap( 'edit_others_lpr_trivia' );
