...
//                          $('.button-start-quiz').on('click',$.proxy(this.startQuiz,this));
//                        $('.button-finish-quiz').on('click',$.proxy(this.finishQuiz,this));
//                        $('.button-retake-quiz').on('click',$.proxy(this.retakeQuiz,this));
//                        $('.next-question').on('click',$.proxy(this.nextQuestion,this));
//                        $('.prev-question').on('click',$.proxy(this.prevQuestion,this));
//                        $('.check_answer').on('click',$.proxy(this.showAnswer,this));
...
//       console.log(LearnPress_View_Quiz);
	...
	LearnPress = $.extend(
		LearnPress, {
			...
			initQuiz: function (data) { console.log(data);
