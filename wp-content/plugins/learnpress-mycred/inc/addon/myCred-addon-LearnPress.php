 ...
 */
require_once( LPR_MC_PATH . '/inc/hooks/mycred-hook-learnpress-learner.php' );
require_once( LPR_MC_PATH . '/inc/hooks/mycred-hook-learnpress-instructor.php' );
...
$learnpress = new myCRED_LearnPress_Module();
$learnpress->load();
