...
?>
<input type="number" class="cert-option-slider-value" name="<?php echo $field['name'];?>" value="<?php echo $field['std'];?>" min="<?php echo $field['min'];?>" max="<?php echo $field['max'];?>" step="<?php echo $field['step'];?>" />
