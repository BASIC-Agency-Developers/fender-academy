...
if ( ! class_exists( 'RWMB_Certificate_Field' ) && class_exists( 'RWMB_Field' ) ) {
    class RWMB_Certificate_Field extends RWMB_Field {
        ...
        static function add_actions() {
            ...
            wp_enqueue_style( 'rwmb-certificate-select-css', LPR_Certificate::instance()->get_plugin_url( 'assets/css/certificate-select.css' ) );
            wp_enqueue_script( 'rwmb-certificate-select-script', LPR_Certificate::instance()->get_plugin_url( 'assets/js/certificate-select.js' ), array('jquery', 'jquery-ui-sortable', 'jquery-ui-droppable', 'jquery-ui-draggable') );
